  ...
  return (
    <div className="relative grid grid-cols-12 gap-8 py-24 px-16 bg-window rounded-lg shadow-md text-white">
      <div className="relative grid grid-cols-4 gap-8 col-span-12 lg:col-span-4 lg:flex lg:flex-col">
        <h3 className="font-sans text-5xl col-span-4 -ml-16 pl-16 pb-4 border-b-2 border-electric-teal">
          {projectTitle}
        </h3>
        ...
        <motion.a
          ...
          className="text-4xl text-center col-span-4 justify-self-start lg:self-start p-4 lg:px-8 lg:py-4 lg:mt-auto text-electric-teal border-electric-teal border-2 with-arrow"
          whileHover={{
            scale: 1.05
          }}
          whileTap={{
