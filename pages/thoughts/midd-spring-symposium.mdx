...
export const meta = {
  ...
  description:
    'I present my senior research on mixing code and feminist methodologies into the GIS classroom to my peers at the Middlebury College Undergraduate Research Symposium.',
