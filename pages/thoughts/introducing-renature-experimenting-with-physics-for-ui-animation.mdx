...
export const meta = {
  ...
  slug: 'introducing-renature-experimenting-with-physics-for-ui-animation',
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">We&#39;ve been making awesome progress on `renature` (a new physics animation library for React) here at <a href="https://twitter.com/FormidableLabs?ref_src=twsrc%5Etfw">@FormidableLabs</a>. gravity is the first force we tackled! Here&#39;s a body with a mass of 2000kg being attracted to a body 50,000 times its size. <a href="https://t.co/d1D9eMqZeW">pic.twitter.com/d1D9eMqZeW</a></p>&mdash; parkie-doo (@parker_ziegler) <a href="https://twitter.com/parker_ziegler/status/1204157892061908993?ref_src=twsrc%5Etfw">December 9, 2019</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
![renature gravity simulation](/blogs/introducing-renature-experimenting-with-physics-for-ui-animation/gravity-simulation.svg)
...
![renature gravity simulation with opacity](/blogs/introducing-renature-experimenting-with-physics-for-ui-animation/gravity-simulation-opacity.gif)
...
![renature gravity simulation with background-color](/blogs/introducing-renature-experimenting-with-physics-for-ui-animation/gravity-simulation-bg-color.gif)
...
![renature gravity simulation in two dimensions](/blogs/introducing-renature-experimenting-with-physics-for-ui-animation/gravity-simulation-2d.gif)
