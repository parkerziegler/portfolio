...
![renature gravity simulation](/thoughts/introducing-renature-experimenting-with-physics-for-ui-animation/gravity-simulation.svg)
...
![renature gravity simulation with opacity](/thoughts/introducing-renature-experimenting-with-physics-for-ui-animation/gravity-simulation-opacity.gif)
...
![renature gravity simulation with background-color](/thoughts/introducing-renature-experimenting-with-physics-for-ui-animation/gravity-simulation-bg-color.gif)
...
![renature gravity simulation in two dimensions](/thoughts/introducing-renature-experimenting-with-physics-for-ui-animation/gravity-simulation-2d.gif)
