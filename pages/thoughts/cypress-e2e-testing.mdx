...
<BlogPost title={meta.title} tags={[TAGS.react,TAGS.testing, TAGS.cypress]}>
...
![A screenshot of the Websockets documentation for Cypress.](/thoughts/cypress-e2e-testing/cypress-websockets-docs.png)
