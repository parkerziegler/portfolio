...
![A map examining the spatial correlations between non-violent drug arrests and race in Chicago.](/thoughts/python-scripting-for-automated-geoprocessing/crack-map.jpg)
