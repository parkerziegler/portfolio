...
<BlogPost title={meta.title} tags={[TAGS.javascript, TAGS.gis]}>
...
![A screenshot of the Leaflet map Professor Holler and I created for the Zuni Youth Enrichment Project (ZYEP).](/thoughts/zyep-map/zyep-map.png)
