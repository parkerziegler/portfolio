...
export const meta = {
  ...
  slug: 'writing-documentation-for-the-awr-custom-tool',
  date: 'March 24, 2016',
  tags: ['python', 'gis']
};

<BlogPost tags={[TAGS.python, TAGS.gis]}>
...
[Click here to access the documentation for my areal-weighted reaggregation (AWR) tool.](/thoughts/writing-documentation-for-the-awr-custom-tool/awr-documentation.pdf)
