...
![The result of the above HTML – two clean, user-friendly dropdown menus.](/blogs/building-interactive-d3-dashboards-with-carto-web-maps/carto-dropdowns.png)
...
![Notice how we changed the dropdown to Brooklyn and we are now zoomed into downtown Brooklyn. jQuery is a powerful framework for handling DOM-Javascript interaction.](/blogs/building-interactive-d3-dashboards-with-carto-web-maps/carto-web-map.png)
...
![Look at that beautifully positioned data! Applying 50% transparency to the points allows overlapping data to be highlighted.](/blogs/building-interactive-d3-dashboards-with-carto-web-maps/d3-scatterplot.png)
...
![Adding axes and a title helps to make the data readable and understandable. In this case, we see that there is a strong positive correlation between population density and crash density. But what about other variables?](/blogs/building-interactive-d3-dashboards-with-carto-web-maps/d3-axes.png)
