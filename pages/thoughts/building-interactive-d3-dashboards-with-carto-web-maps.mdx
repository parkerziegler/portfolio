...
export const meta = {
  ...
  slug: 'building-interactive-d3-dashboards-with-carto-web-maps',
  date: 'September 26, 2016',
  tags: ['d3', 'carto', 'gis']
};

<BlogPost tags={[TAGS.d3, TAGS.carto, TAGS.gis]}>
...
![The result of the above HTML – two clean, user-friendly dropdown menus.](/thoughts/building-interactive-d3-dashboards-with-carto-web-maps/carto-dropdowns.png)
...
![Notice how we changed the dropdown to Brooklyn and we are now zoomed into downtown Brooklyn. jQuery is a powerful framework for handling DOM-Javascript interaction.](/thoughts/building-interactive-d3-dashboards-with-carto-web-maps/carto-web-map.png)
...
![Look at that beautifully positioned data! Applying 50% transparency to the points allows overlapping data to be highlighted.](/thoughts/building-interactive-d3-dashboards-with-carto-web-maps/d3-scatterplot.png)
...
![Adding axes and a title helps to make the data readable and understandable. In this case, we see that there is a strong positive correlation between population density and crash density. But what about other variables?](/thoughts/building-interactive-d3-dashboards-with-carto-web-maps/d3-axes.png)
...
![Notice that we have the Poverty Rate layer selected in the dropdown, the Poverty Rate layer is showing on the map, and the scatterplot is showing the relationship between Poverty Rate and Crash Density. Ah, the beauty of Integrated data views.](/thoughts/building-interactive-d3-dashboards-with-carto-web-maps/d3-carto-web-map.png)
