...
export const meta = {
  ...
  slug:
    'help-professor-hollder-build-an-interactive-map-for-the-zuni-youth-enrichment-project-zyep',
  date: 'May 4, 2016',
  tags: ['javascript', 'gis']
};

<BlogPost tags={[TAGS.javascript, TAGS.gis]}>
...
![A screenshot of the Leaflet map Professor Holler and I created for the Zuni Youth Enrichment Project (ZYEP).](/thoughts/help-professor-holler-build-an-interactive-map-for-the-zuni-youth-enrichment-project-zyep/zyep-map.png)
...
<ol>
  <li>Your ability to find good, reliable help at your level</li>
  <li>The availability of an example to base your work on</li>
  <li>The stubbornness to persist in the face of setbacks</li>
</ol>
