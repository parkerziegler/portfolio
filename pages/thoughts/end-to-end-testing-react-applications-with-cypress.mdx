...
<BlogPost tags={[TAGS.react,TAGS.testing, TAGS.cypress]}>
...
![Websockets documentation for Cypress](/thoughts/end-to-end-testing-react-applications-with-cypress/cypress-websockets-docs.png)
