...
export const meta = {
  ...
  slug: 'presenting-at-the-middlebury-spring-symposium',
  date: 'April 18, 2016',
  tags: ['speaking']
};

<BlogPost tags={[TAGS.speaking]}>
...
<ol>
  <li>
    Posing a problem that geospatial technologies can illuminate or help us to
    understand. I am particularly attracted to problems of the social variety.
  </li>
  <li>
    Thinking about the problem first through a software-independent lens. This
    emphasizes considering just the actual spatial relationships we want to
    model.
  </li>
  <li>
    Reframing the problem through code – that is, how do we model relationships
    that are spatial in nature through syntax and language?
  </li>
  <li>
    Troubleshooting the inevitable errors that emerge. Because let's be honest –
    programming is more debugging than anything else.
  </li>
  <li>
    Abstracting the problem to imagine a scalable solution. The key here is
  ...
  <li>
    Testing our solution through different problems and broader application.
    Here we are obliged to ask that scary question – does our code actually hold
    up?
  </li>
  <li>
    Visualizing our solution and sharing the tools we used to make it. Data that
