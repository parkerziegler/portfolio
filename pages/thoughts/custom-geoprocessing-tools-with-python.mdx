...
<img
  src="/thoughts/custom-geoprocessing-tools-with-python/awr-nc-in.png"
...
<img
  src="/thoughts/custom-geoprocessing-tools-with-python/awr-chicago.jpg"
...
Ultimately, it was a remarkably satisfying experience to write this tool and see
it come to life. It was also a terrific lesson in learning how to abstract a specific
problem into something that can be more universally applied. If you have further
questions about how this tool works or how to get it to work in your own ArcMap project,
feel free to reach out [on Twitter](https://twitter.com/parker_ziegler). Check back
in a few weeks for an update on my upcoming work with relational databases and my
presentation at AAG!
