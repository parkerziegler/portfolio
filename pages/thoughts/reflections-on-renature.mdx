...
export const meta = {
  ...
  description:
    'In this post, I reflect back on the experience of authoring renature, a new physics-based animation library for React, and how working on open source full-time can be transformative for fostering personal creativity.',
