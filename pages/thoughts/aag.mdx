...
import AAGSrc from '../../public/thoughts/aag/aag.png';

export const meta = {
  title:
    'Presenting at the American Association of Geographers (AAG) Annual Conference',
  description:
    'I head to the American Association of Geographers (AAG) annual conference in San Francisco to present my senior research on mixing code and feminist methodologies into the GIS classroom.',
  slug: 'aag',
  date: 'Apr. 4, 2016',
  tags: ['speaking']
};
...
<img
  src={AAGSrc.src}
  alt="Presenting at AAG 2016 in San Francisco, CA as part of the GIS and Technology Poster Session."
/>
