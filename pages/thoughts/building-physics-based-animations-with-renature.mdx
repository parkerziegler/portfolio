...
![The standard equation of friction.](/blogs/building-physics-based-animations-with-renature/friction-equation.svg)
...
![The friction simulation in renature.](/blogs/building-physics-based-animations-with-renature/friction-simulation.svg)

If you've heard of Newton's laws, you've probably heard this expression before — _force equals mass times acceleration_.

![Force equals mass times acceleration](/blogs/building-physics-based-animations-with-renature/force-equation.svg)

And just above, we derived the force of friction, so we can say:

![Standard equation of friction with ma substituted for F.](/blogs/building-physics-based-animations-with-renature/friction-equation-2.svg)
...
![Calculating acceleration caused by the force of friction](/blogs/building-physics-based-animations-with-renature/force-equation-2.svg)
...
![Velocity as a function of acceleration and time](/blogs/building-physics-based-animations-with-renature/force-equation-3.svg)

The same relationship holds for position, **p**, in relation to velocity:

![Position as a function of velocity and time](/blogs/building-physics-based-animations-with-renature/force-equation-4.svg)
...
![The friction simulation in renature.](/blogs/building-physics-based-animations-with-renature/friction-simulation-2.svg)
