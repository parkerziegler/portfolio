...
import FrictionEquationSrc from '../../public/thoughts/building-physics-based-animations-with-renature/friction-equation.svg';
import FrictionEquation2Src from '../../public/thoughts/building-physics-based-animations-with-renature/friction-equation-2.svg';
...
import ForceEquationSrc from '../../public/thoughts/building-physics-based-animations-with-renature/force-equation.svg';
import ForceEquation2Src from '../../public/thoughts/building-physics-based-animations-with-renature/force-equation-2.svg';
import ForceEquation3Src from '../../public/thoughts/building-physics-based-animations-with-renature/force-equation-3.svg';
import ForceEquation4Src from '../../public/thoughts/building-physics-based-animations-with-renature/force-equation-4.svg';
...
<img
  src={FrictionEquationSrc}
  alt="The standard equation of friction."
/>
...
<img
  src={ForceEquationSrc}
  alt="Force equals mass times acceleration."
/>

And just above, we derived the force of friction, so we can say:

<img
  src={FrictionEquation2Src}
  alt="Standard equation of friction with ma substituted for F."
/>
...
<img
  src={ForceEquation2Src}
  alt="Calculating acceleration caused by the force of friction."
/>
...
<img
  src={ForceEquation3Src}
  alt="Velocity as a function of acceleration and time."
/>

The same relationship holds for position, **p**, in relation to velocity:

<img
  src={ForceEquation4Src}
  alt="Position as a function of velocity and time."
/>
