...
<BlogPost title={meta.title} tags={[TAGS.d3, TAGS.carto, TAGS.gis]} publishDate={meta.date}>
...
<img
  src="/thoughts/d3-carto/carto-web-map.png"
...
<img
  src="/thoughts/d3-carto/carto-web-map-poverty-rate.png"
