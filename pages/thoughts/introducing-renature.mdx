...
<BlogPost title={meta.title} tags={[TAGS.react, TAGS.animation]}>
...
![A visual model of Renature's gravity simulation.](/thoughts/introducing-renature/gravity-simulation.svg)
...
![An example of Renature's gravity simulation animating opacity.](/thoughts/introducing-renature/gravity-simulation-opacity.gif)
...
![Renature's gravity simulation with background-color.](/thoughts/introducing-renature/gravity-simulation-bg-color.gif)
...
![renature gravity simulation running in two dimensions.](/thoughts/introducing-renature/gravity-simulation-2d.gif)
